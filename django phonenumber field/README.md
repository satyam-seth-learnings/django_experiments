### [`django-phonenumber-field` pypi Link](https://pypi.org/project/django-phonenumber-field/#:~:text=A%20Django%20library%20which%20interfaces,around%20python%2Dphonenumbers'%20PhoneNumber%20class)

### [`django-phonenumber-field` Github Link](https://github.com/stefanfoulis/django-phonenumber-field)

### [`PhoneNumberField` Model Field examples](https://github.com/stefanfoulis/django-phonenumber-field/blob/main/tests/models.py)
...
```python
    ...
    class PhoneNumberForm1(forms.Form):
        phone_number = PhoneNumberField()
```
...
```HTML
    <label for="id_phone_number_0">Phone number:</label>
    <select name="phone_number_0" required id="id_phone_number_0">
